...
export interface ApiUserManagerUserManager extends Struct.SingleTypeSchema {
  collectionName: 'user_manager';
  info: {
    description: 'Simple user management helper';
    displayName: 'User Manager';
    pluralName: 'user-managers';
    singularName: 'user-manager';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-manager.user-manager'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.DefaultTo<'User Manager'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::user-manager.user-manager': ApiUserManagerUserManager;
