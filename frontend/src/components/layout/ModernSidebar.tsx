...
export default function ModernSidebar() {
  ...
  const [activeItem, setActiveItem] = useState('dashboard'); // Dashboard como padrão
      ...
      <div className={`relative transition-all duration-300 ease-out ${
        ...
        <div className={`transition-opacity duration-300 ${isHovered ? 'opacity-100' : 'opacity-0'} drop-shadow-lg`}>
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center space-y-8 py-16">
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={getIconColor('enchimento')} strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M5 10l7-7m0 0l7 7m-7-7v18"/>
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 21h18"/>
                <path strokeLinecap="round" strokeLinejoin="round" d="M7 16h10v5H7v-5z"/>
              </svg>
            </button>
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={getIconColor('porta_jusante')} strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M8 14v3a2 2 0 002 2h4a2 2 0 002-2v-3M8 14V7a2 2 0 012-2h4a2 2 0 012 2v7M8 14l-2-2m6 2l2-2" />
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={getIconColor('porta_montante')} strokeWidth="2">
                <path strokeLinecap="round" strokeLinejoin="round" d="M8 10v3a2 2 0 002 2h4a2 2 0 002-2v-3M8 10V7a2 2 0 012-2h4a2 2 0 012 2v3M8 10l-2 2m6-2l2 2" />
