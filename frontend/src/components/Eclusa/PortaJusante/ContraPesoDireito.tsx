...
interface ContraPesoDireitoProps {
  editMode?: boolean;
  componentId?: string;
  ...
  posicaoY?: number;
  nivel?: number;
  width?: number; // Vem do ResponsiveWrapper
  height?: number; // Vem do ResponsiveWrapper
}

const ContraPesoDireito: React.FC<ContraPesoDireitoProps> = ({ 
  editMode = false,
  componentId = 'porta-jusante-contrapeso-direito-default',
  posicaoInicial = 0,
  posicaoMaxima = 300,
  posicaoY = 0,
  nivel,
  ...
  useEffect(() => {
    console.log('🔧 ContraPesoDireito montado com ID:', componentId);
  }, [componentId]);
  ...
  return (
    <ResponsiveWrapper 
      ...
      editMode={editMode}
      defaultConfig={{
        xs: { x: 50, y: 50, width: 150, height: 500, scale: 1, zIndex: 1, opacity: 1, rotation: 0 },
        sm: { x: 100, y: 100, width: 200, height: 600, scale: 1, zIndex: 1, opacity: 1, rotation: 0 },
        md: { x: 150, y: 150, width: 250, height: 700, scale: 1, zIndex: 1, opacity: 1, rotation: 0 },
        lg: { x: 200, y: 200, width: 300, height: 800, scale: 1, zIndex: 1, opacity: 1, rotation: 0 },
        xl: { x: 250, y: 250, width: 350, height: 900, scale: 1, zIndex: 1, opacity: 1, rotation: 0 },
        '2xl': { x: 300, y: 300, width: 400, height: 1000, scale: 1, zIndex: 1, opacity: 1, rotation: 0 },
        '3xl': { x: 350, y: 350, width: 450, height: 1100, scale: 1, zIndex: 1, opacity: 1, rotation: 0 },
        '4xl': { x: 400, y: 400, width: 500, height: 1200, scale: 1, zIndex: 1, opacity: 1, rotation: 0 }
      }}
    >
      <div className={`flex items-center gap-4 w-full h-full ${editMode ? 'border-2 border-orange-500 bg-orange-50/20' : ''}`}>
        ...
        <div className="relative w-full h-full">
          <svg 
            ...
            style={{ transform: `scale(${width / 200}, ${height / 600})` }}
          >
            {/* Linha preta */}
            <rect 
              x="46" 
            ...
            {/* Contrapeso SVG */}
            <g transform={`translate(20, ${linhaHeight + posicaoY})`} style={{ transition: 'transform 0.5s linear' }}>
              <path d="M8.79614 85.9591C3.15737 85.038 -0.00654874 83.7889 1.27065e-05 82.4863L59.4604 82.4947C59.4465 83.7972 57.0191 85.0405 51.3659 85.961C45.7127 86.8816 38.0525 87.3985 30.0697 87.3982C22.0869 87.3978 14.4349 86.8802 8.79614 85.9591Z" fill="url(#paint0_linear_1731_1450_direito)"/>
              <path d="M8.79614 85.3097C3.15737 84.3886 -0.00654874 83.1395 1.27065e-05 81.8369L59.4604 81.8453C59.4465 83.1478 57.0191 84.3911 51.3659 85.3116C45.7127 86.2322 38.0525 86.7491 30.0697 86.7487C22.0869 86.7484 14.4349 86.2307 8.79614 85.3097Z" fill="url(#paint1_linear_1731_1450_direito)"/>
              <path d="M59.4578 82.4669H0L0.145464 8.1416H59.4578V82.4669Z" fill="url(#paint2_linear_1731_1450_direito)"/>
              <path d="M59.2763 9.05947C59.2763 9.32389 59.1413 9.62664 58.786 9.96697C58.4305 10.3076 57.8856 10.654 57.1498 10.995C55.6803 11.676 53.5302 12.299 50.8435 12.8256C45.4763 13.8777 38.0452 14.5311 29.8257 14.5311C21.6062 14.5311 14.1751 13.8777 8.80787 12.8256C6.12119 12.299 3.97102 11.676 2.50153 10.995C1.76573 10.654 1.2209 10.3076 0.865362 9.96697C0.510093 9.62664 0.375 9.32389 0.375 9.05947C0.375 8.79506 0.510093 8.49231 0.865362 8.15198C1.2209 7.8114 1.76573 7.46497 2.50153 7.12396C3.97102 6.44291 6.12119 5.81997 8.80787 5.29331C14.1751 4.24121 21.6062 3.58789 29.8257 3.58789C38.0452 3.58789 45.4763 4.24121 50.8435 5.29331C53.5302 5.81997 55.6803 6.44291 57.1498 7.12396C57.8856 7.46497 58.4305 7.8114 58.786 8.15198C59.1413 8.49231 59.2763 8.79506 59.2763 9.05947Z" fill="url(#paint3_linear_1731_1450_direito)" stroke="#C0C0C0" strokeWidth="0.75"/>
            ...
            <defs>
              <linearGradient id="paint0_linear_1731_1450_direito" x1="59.324" y1="82.899" x2="0.000263421" y2="82.9339" gradientUnits="userSpaceOnUse">
                <stop stopColor="#808080"/>
                <stop offset="0.5" stopColor="white"/>
                <stop offset="1" stopColor="#808080"/>
              </linearGradient>
              <linearGradient id="paint1_linear_1731_1450_direito" x1="59.324" y1="82.2496" x2="0.000263421" y2="82.2845" gradientUnits="userSpaceOnUse">
                <stop stopColor="#808080"/>
                <stop offset="0.5" stopColor="white"/>
                <stop offset="1" stopColor="#808080"/>
              </linearGradient>
              <linearGradient id="paint2_linear_1731_1450_direito" x1="59.3212" y1="14.5394" x2="-2.15862e-07" y2="14.5394" gradientUnits="userSpaceOnUse">
                <stop stopColor="#808080"/>
                <stop offset="0.5" stopColor="white"/>
                <stop offset="1" stopColor="#808080"/>
              </linearGradient>
              <linearGradient id="paint3_linear_1731_1450_direito" x1="59.6513" y1="9.05947" x2="0" y2="9.05947" gradientUnits="userSpaceOnUse">
                <stop stopColor="#808080"/>
                <stop offset="0.5" stopColor="white"/>
                <stop offset="1" stopColor="#808080"/>
              </linearGradient>
...
export default ContraPesoDireito;