    ...
    >
      ...
      >
        ...
        <path 
          fillRule="evenodd" 
          clipRule="evenodd" 
          d="M530.186 48.87C744.374 50.5145 933.718 209.364 933.718 467.585C933.718 725.811 724.736 935.14 466.94 935.14L428.523 933.2V860.862L466.94 862.809C684.756 862.809 861.327 685.858 861.327 467.585C860.505 237.802 690.406 118.33 530.186 118.33C317.304 118.33 222.864 281.116 222.864 388.398C222.864 497.534 271.122 559.44 337.556 603.006L304.131 664.49C195.178 599.178 153.694 502.621 152.527 387.161C150.059 226.775 293.782 48.0482 530.186 48.87Z" 
          fill="url(#paint5_linear)"
        />
        
        <defs>
          <linearGradient id="paint0_linear" x1="293.5" y1="889.5" x2="368.766" y2="935.141" gradientUnits="userSpaceOnUse">
            <stop stopColor="#6E33FF"/>
            <stop offset="0.996215" stopColor="#00B1EB"/>
          </linearGradient>
          <linearGradient id="paint1_linear" x1="429.917" y1="261.102" x2="174" y2="375" gradientUnits="userSpaceOnUse">
            <stop offset="0.502669" stopColor="#00FFFF"/>
            <stop offset="1" stopColor="#24CFFF"/>
          </linearGradient>
          <linearGradient id="paint2_linear" x1="670.512" y1="733.5" x2="948.012" y2="265" gradientUnits="userSpaceOnUse">
            <stop offset="0.577598" stopColor="#00FFFF"/>
            <stop offset="1" stopColor="#6E33FF"/>
          </linearGradient>
          <linearGradient id="paint3_linear" x1="637.465" y1="455" x2="469" y2="404" gradientUnits="userSpaceOnUse">
            <stop stopColor="#22FF6C"/>
            <stop offset="0.783672" stopColor="#00FFFF"/>
          </linearGradient>
          <linearGradient id="paint4_linear" x1="287" y1="503.5" x2="488.115" y2="693.033" gradientUnits="userSpaceOnUse">
            <stop stopColor="#3BFF04"/>
            <stop offset="1" stopColor="#21FF6C"/>
          </linearGradient>
          <linearGradient id="paint5_linear" x1="838.5" y1="635" x2="849.5" y2="702.5" gradientUnits="userSpaceOnUse">
            <stop stopColor="#3BFF04"/>
