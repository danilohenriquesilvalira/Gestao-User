...
const Motor: React.FC<MotorProps> = ({ 
  ...
  const currentStatus = websocketValue !== null ? websocketValue as (0 | 1 | 2) : status;
  const [isManualControl, setIsManualControl] = useState(false);

  // Log para debug
  useEffect(() => {
    console.log(`⚙️ Motor - websocketValue: ${websocketValue}, currentStatus: ${currentStatus}`);
  }, [websocketValue, currentStatus]);
  ...
  const handleManualChange = (value: number) => {
    console.log(`👆 Motor controle manual ativado: ${value}`);
    setIsManualControl(true);
    
    // Volta para controle automático após 5 segundos
    setTimeout(() => {
      console.log('🤖 Motor voltando para controle automático');
  ...
  return (
    <ResponsiveWrapper 
      ...
      editMode={editMode}
      defaultConfig={{
        xs: { x: 250, y: 100, width: 100, height: 60, scale: 0.8, zIndex: 45, opacity: 1, rotation: 0 },
        sm: { x: 300, y: 120, width: 120, height: 70, scale: 0.9, zIndex: 45, opacity: 1, rotation: 0 },
        md: { x: 350, y: 150, width: 140, height: 80, scale: 1.0, zIndex: 45, opacity: 1, rotation: 0 },
        lg: { x: 600, y: 180, width: 160, height: 90, scale: 1.1, zIndex: 45, opacity: 1, rotation: 0 },
        xl: { x: 750, y: 200, width: 180, height: 100, scale: 1.2, zIndex: 45, opacity: 1, rotation: 0 },
        '2xl': { x: 850, y: 220, width: 200, height: 110, scale: 1.3, zIndex: 45, opacity: 1, rotation: 0 },
        '3xl': { x: 950, y: 240, width: 220, height: 120, scale: 1.4, zIndex: 45, opacity: 1, rotation: 0 },
        '4xl': { x: 1050, y: 260, width: 240, height: 130, scale: 1.5, zIndex: 45, opacity: 1, rotation: 0 },
      }}
    >
      <div className="w-full h-full">
        {showControls && (
          <div className="absolute -top-32 left-0 bg-black text-white p-3 rounded z-50 text-xs min-w-[300px]">
            <div className="space-y-2">
              {/* Status da conexão */}
              <div className="flex items-center gap-2">
                <div className={`w-3 h-3 rounded-full ${websocketValue !== null ? 'bg-green-500' : 'bg-red-500'}`}></div>
                <span className="text-xs">
                  Motor: {websocketValue !== null ? 'Conectado' : 'Desconectado'}
                </span>
              </div>
              ...
              <div className="text-xs text-yellow-400 space-y-1">
                <div>WebSocket Value: {websocketValue ?? 'null'}</div>
                <div>Current Status: {currentStatus}</div>
                <div>Manual Control: {isManualControl ? 'SIM' : 'NÃO'}</div>
              </div>
        ...
        >
          ...
          {/* Seção vermelha do motor - Mantém sua cor original */}
          ...
          {/* Gradientes únicos para evitar conflitos */}
          <defs>
            <linearGradient id="paint0_linear_motor_122" x1="21.7653" y1="8.92561" x2="21.7653" y2="21.2031" gradientUnits="userSpaceOnUse">
            ...
            <linearGradient id="paint2_linear_motor_122" x1="50.5425" y1="5.00809" x2="50.5425" y2="7.37895" gradientUnits="userSpaceOnUse">
              <stop stopColor="#F2F2F2" stopOpacity="0.4"/>
              <stop offset="1" stopColor="#F7F7F7" stopOpacity="0.7"/>
            </linearGradient>
            <linearGradient id="paint3_linear_motor_122" x1="71.4532" y1="20.0994" x2="71.4532" y2="33.8665" gradientUnits="userSpaceOnUse">
            ...
            <linearGradient id="paint5_linear_motor_122" x1="25.9806" y1="7.40073" x2="26.4687" y2="10.8722" gradientUnits="userSpaceOnUse">
              <stop stopColor="#F2F2F2" stopOpacity="0.4"/>
              <stop offset="1" stopColor="#F7F7F7" stopOpacity="0.7"/>
            </linearGradient>
            <linearGradient id="paint7_linear_motor_122" x1="76.8263" y1="5.15045" x2="76.4738" y2="7.66402" gradientUnits="userSpaceOnUse">
              <stop stopColor="#F2F2F2" stopOpacity="0.4"/>
              <stop offset="1" stopColor="#F7F7F7" stopOpacity="0.7"/>
            </linearGradient>
            <linearGradient id="paint8_linear_motor_122" x1="48.6263" y1="4.33769" x2="48.6263" y2="45.6186" gradientUnits="userSpaceOnUse">
              <stop stopColor="#666666"/>
              <stop offset="1" stopColor="#1A1A1A"/>
            </linearGradient>
            <linearGradient id="paint9_linear_motor_122" x1="48.771" y1="1.21577" x2="48.771" y2="34.8602" gradientUnits="userSpaceOnUse">
              <stop/>
            ...
            <linearGradient id="paint10_linear_motor_122" x1="95.5562" y1="21.4568" x2="19.6094" y2="53.924" gradientUnits="userSpaceOnUse">
              <stop stopColor="white"/>
              <stop offset="1" stopColor="#7C7C7B"/>
            </linearGradient>
            <linearGradient id="paint12_linear_motor_122" x1="57.137" y1="29.7283" x2="44.9837" y2="46.2284" gradientUnits="userSpaceOnUse">
              <stop stopColor="#666666"/>
              <stop offset="1" stopColor="#1A1A1A"/>
            </linearGradient>
          </defs>
