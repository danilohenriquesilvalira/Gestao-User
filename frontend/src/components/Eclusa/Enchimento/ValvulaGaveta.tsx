...
const ValvulaGaveta: React.FC<ValvulaGavetaProps> = ({
  ...
  // Configurações padrão ajustadas para válvulas gaveta (maiores que direcionais)
  const gavetaDefaultConfig = {
    xs: { x: 10, y: 70, width: 120, height: 110, scale: 0.7, zIndex: 1, opacity: 1, rotation: 0 },
    sm: { x: 20, y: 70, width: 140, height: 130, scale: 0.8, zIndex: 1, opacity: 1, rotation: 0 },
    md: { x: 30, y: 70, width: 160, height: 150, scale: 0.9, zIndex: 1, opacity: 1, rotation: 0 },
    lg: { x: 50, y: 70, width: 180, height: 170, scale: 1, zIndex: 1, opacity: 1, rotation: 0 },
    xl: { x: 74, y: 70, width: 200, height: 190, scale: 1, zIndex: 1, opacity: 1, rotation: 0 },
    '2xl': { x: 100, y: 70, width: 220, height: 210, scale: 1, zIndex: 1, opacity: 1, rotation: 0 },
    '3xl': { x: 120, y: 70, width: 240, height: 230, scale: 1, zIndex: 1, opacity: 1, rotation: 0 },
    '4xl': { x: 150, y: 70, width: 260, height: 250, scale: 1, zIndex: 1, opacity: 1, rotation: 0 }
  };
  ...
  return (
    <ResponsiveWrapper 
      ...
      defaultConfig={gavetaDefaultConfig}
    >
      <svg 
        width="100%" 
        height="100%" 
